...
public class Food_SceneController {
    ...
    @FXML
    void initialize() {
        selectedItem = inventory.filterItem(Item.ItemType.FOOD)[0][0];
    ...
    @FXML
    void itm2Clicked() {
        selectedItem = inventory.filterItem(Item.ItemType.FOOD)[0][1];
        itmName.setText(selectedItem.getName());
        itmType.setText(selectedItem.getType().toString());
        itmElement.setText(selectedItem.getElementType().toString());
        itmAmount.setText(Integer.toString(selectedItem.getInventoryAmount()));
    ...
    @FXML
    void itm3Clicked() {
        selectedItem = inventory.filterItem(Item.ItemType.FOOD)[0][2];
        itmName.setText(selectedItem.getName());
        itmType.setText(selectedItem.getType().toString());
        itmElement.setText(selectedItem.getElementType().toString());
        itmAmount.setText(Integer.toString(selectedItem.getInventoryAmount()));
    ...
    @FXML
    void itm4Clicked() {
        selectedItem = inventory.filterItem(Item.ItemType.FOOD)[0][3];
        itmName.setText(selectedItem.getName());
        itmType.setText(selectedItem.getType().toString());
        itmElement.setText(selectedItem.getElementType().toString());
        itmAmount.setText(Integer.toString(selectedItem.getInventoryAmount()));
    ...
    @FXML
    void itm5Clicked() {
        selectedItem = inventory.filterItem(Item.ItemType.FOOD)[1][0];
        itmName.setText(selectedItem.getName());
        itmType.setText(selectedItem.getType().toString());
        itmElement.setText(selectedItem.getElementType().toString());
        itmAmount.setText(Integer.toString(selectedItem.getInventoryAmount()));
    ...
    @FXML
    void itm6Clicked() {
        selectedItem = inventory.filterItem(Item.ItemType.FOOD)[1][1];
        itmName.setText(selectedItem.getName());
        itmType.setText(selectedItem.getType().toString());
        itmElement.setText(selectedItem.getElementType().toString());
        itmAmount.setText(Integer.toString(selectedItem.getInventoryAmount()));
    ...
    @FXML
    void itm7Clicked() {
        selectedItem = inventory.filterItem(Item.ItemType.FOOD)[1][2];
        itmName.setText(selectedItem.getName());
        itmType.setText(selectedItem.getType().toString());
        itmElement.setText(selectedItem.getElementType().toString());
        itmAmount.setText(Integer.toString(selectedItem.getInventoryAmount()));
    ...
    @FXML
    void itm8Clicked() {
        selectedItem = inventory.filterItem(Item.ItemType.FOOD)[1][3];
        itmName.setText(selectedItem.getName());
        itmType.setText(selectedItem.getType().toString());
        itmElement.setText(selectedItem.getElementType().toString());
        itmAmount.setText(Integer.toString(selectedItem.getInventoryAmount()));
    ...
    @FXML
    void itm9Clicked() {
        selectedItem = inventory.filterItem(Item.ItemType.FOOD)[2][0];
        itmName.setText(selectedItem.getName());
        itmType.setText(selectedItem.getType().toString());
        itmElement.setText(selectedItem.getElementType().toString());
        itmAmount.setText(Integer.toString(selectedItem.getInventoryAmount()));
    ...
    void selectBtnClicked(ActionEvent event) throws IOException {
        if (selectedItem.getInventoryAmount() > 0) {
            pet.feed(inventory, selectedItem);
            App.setRoot(CurrentState.getInstance().returnScene());
        } else {
            Alert alert = new Alert(Alert.AlertType.ERROR);
            alert.setTitle("Insufficient Inventory");
            alert.setHeaderText("Not Enough Items");
            alert.setContentText("The selected item is not available in sufficient quantity.");
            alert.showAndWait();
        }
    }
