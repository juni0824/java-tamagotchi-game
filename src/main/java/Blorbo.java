...
/**
 * The Blorbo class represents one of the three types of pets in the CS2212 group 88 Virtual Pet Project.
 ...
 * @see Pet
 */
public class Blorbo implements Pet {
    private final ElementType type = ElementType.WATER;
    private final int vetFee = 100;
    private int maxHealth = 150;
    private int maxSleep = 100;
    private int maxFullness = 100;
    private int maxHappiness = 150;
    ...
    private int score;
    private final int baseExp = 20;
    private int exp;
    private int level;

    private String name;
    private String[] sprites = new String[]{"Sprite_Neutral.png", "Sprite_Neutral2.png",
                                            "Sprite_Sleep.png", "Sprite_Sleep2.png",
                                            "Sprite_Mad.png", "Sprite_Mad2.png",
                                            "Sprite_Hungry.png", "Sprite_Hungry2.png",
                                            "Sprite_Dead.png", "Sprite_Happy.png"};
    private String currentSprite = "Sprite_Neutral.png";

    /**
     * Constructor for a new file Blorbo. To be used to start new games.
     */
    public Blorbo() {
        this.name = "Blorbo";
    ...
    /**
     * Constructor for a save file Blorbo. To be used to load saved games.
     *
     * @param name The saved name of the save file Blorbo.
     * @param health The saved health of the save file Blorbo.
     * @param sleep The saved sleep of the save file Blorbo.
     * @param fullness The saved fullness of the save file Blorbo.
     * @param happiness The saved happiness of the save file Blorbo.
     * @param state The saved states of the save file Blorbo.
     * @param score The score of the save file.
     * @param exp The exp of the save file Blorbo.
     * @param level The level of the save file Blorbo.
     */
    public Blorbo(String name, int health, int sleep, int fullness, int happiness,
    ...
    /**
     * {@inheritDoc}
     * Ex. Blorbo's type is WATER, so food with type WATER is preferred and food with type EARTH is restricted.
    ...
    /**
     * {@inheritDoc}
     * Ex. Blorbo's type is WATER, so toys with type WATER are preferred.
     * @param inventory The player's inventory.
    ...
    /**
     * {@inheritDoc}
     * Ex. Blorbo's type is WATER, so gifts of type WATER are preferred.
     * @param inventory The player's inventory.
    ...
    /**
     * {@inheritDoc}
     * Blorbo's fullness decreases by 3 every update. Other stats except for health decrease by 1.
     * Blorbo's health will decrease by 1 every update if fullness is 0.
     * If sleep reaches 0, Blorbo's health will decrease by 10 once.
     */
    ...
    /**
     * Decreases Blorbo's health by a given amount and checks for new dead state.
     */
    ...
    /**
     * Decreases Blorbo's sleep by a given amount and checks for new asleep state.
     */
    ...
    /**
     * Decreases Blorbo's fullness by a given amount and checks for new hungry state.
     */
    private void decreaseFullness(int FULDecr) {
        ...
        } else decreaseHealth(1);
    }

    /**
     * Decreases Blorbo's happiness by a given amount and checks for new angry state.
     */
    ...
    /**
     * Increases sleep by a set amount. Blorbo regenerates sleep at 4/2 seconds when asleep.
     */
     ...
     * @see Blorbo#levelUp(Inventory inventory);
     */
     ...
     * - On even levels, Blorbo's maximum health increases by 5.
     * - On odd levels, Blorbo's maximum happiness increases by 5.
     * - On all levels, Blorbo's maximum fullness increases by 3 and money is rewarded to the player.
     */
    private void levelUp(Inventory inventory) {
        while (exp >= baseExp * level) {
            ...
            maxFullness += 3;
            if (level % 2 == 0) maxHealth += 5;
            else maxHappiness += 5;
        }
    }

    /**
     * Adds score to the player. Base score values are multiplied by level, as per the difficulty level of Blorbo.
     *
     * @param score The score to be added.
     */
